...
select
    ...
    ACC_C_CT,
    APP_C_WL_CCT
from view1 join view2 on view1.BUSINESS_TYPE_CD=view2.BUSINESS_TYPE_CD and view1.et between view2.et -interval '1' second and view2.et + interval '1' second;
...
select
    ...
    ACC_C_CT_1m,
    APP_C_WL_CCT_1m
from view3 JOIN view4 ON view3.BUSINESS_TYPE_CD=view4.BUSINESS_TYPE_CD and view3.et between view4.dt - interval '22' second and view4.dt + interval '1' second;
...
select
    ...
    ACC_C_CT_1m,
    APP_C_WL_CCT_1m
from view3,view4 where view3.BUSINESS_TYPE_CD=view4.BUSINESS_TYPE_CD and view3.et between view4.dt - interval '22' second and view4.dt + interval '1' second;
