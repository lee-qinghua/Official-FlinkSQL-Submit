...
from kafka_apply_info_200 where BUSINESS_TYPE_CD='suixindai' GROUP BY HOP(et,INTERVAL '10' SECOND,INTERVAL '6' HOUR),BUSINESS_TYPE_CD;
...
select
    ...
    RATE_OC_2H,
    RATE_OC_6H
from no_window_source a join mid_table2 b on a.BUSINESS_TYPE_CD=b.BUSINESS_TYPE_CD and a.et between b.dt - interval '10' second and b.dt;
